...
**GPT-6 Luna / high follow-up — 2026-09-26.** The [latest core regression](evals/results/2026-09-26/luna6-closure/REPORT.md) covers two fresh live designs and twelve local cases on V9. All twelve local cases passed scoped review, including test reuse, meaningful missing tests, history checks and handoff authority; a mutation check confirmed the added test detects the intended defect. They ran in two existing sessions after the host refused further fresh agents. The queue design has source support with deployment conditions; analytics still selected a component with insufficient evidence for grouped aggregation. This is not an all-pass or reliability claim. [Earlier returned-content results](evals/results/2026-09-26/luna6-content/REPORT.md) and failures remain available.
